...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'sqlsrv_sigmum' => [
            'driver' => 'sqlsrv',
            'host' => env('DB_SQLSRV_HOST', '172.17.201.201'),
            'port' => env('DB_SQLSRV_PORT', '1433'),
            'database' => env('DB_SQLSRV_DATABASE', 'SIGMUN'),
            'username' => env('DB_SQLSRV_USERNAME', 'sigmun_readonly'),
            'password' => env('DB_SQLSRV_PASSWORD', 'S1gmun**2025$$'),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        //     'password' => env('DB_SQLSRV_PASSWORD', 'mlv**2025$$'),
        //     'charset' => 'utf8',
        //     'prefix' => '',
        //     'prefix_indexes' => true,
        //     'encrypt' => env('DB_SQLSRV_ENCRYPT', 'yes'),

...
<div class="app-content content ">
  <div class="content-wrapper container-xxl p-0">
    <div class="content-body">
      <section id="crear-categoria">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Nueva Categoría Ocupacional</h4>
          </div>
          <div class="card-body">
            <form action="{{ route('categoria-ocupacional.store') }}" method="POST">
              @csrf
              <div class="row">
                ...
                <div class="col-md-6 mb-1">
                  ...
                  <input type="number" name="vacantes" class="form-control" disabled>
                </div>
